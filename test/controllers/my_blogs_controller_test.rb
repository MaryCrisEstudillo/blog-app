...
class MyBlogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_blog" do
    assert_difference('MyBlog.count') do
      post my_blogs_url, params: { my_blog: { author: @my_blog.author, description: @my_blog.description, title: @my_blog.title, topics: @my_blog.topics } }
    end
  ...
  test "should update my_blog" do
    patch my_blog_url(@my_blog), params: { my_blog: { author: @my_blog.author, description: @my_blog.description, title: @my_blog.title, topics: @my_blog.topics } }
